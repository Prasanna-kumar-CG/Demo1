...
Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("quantity").Set "3" @@ script infofile_;_ZIP::ssf9.xml_;_
...
Browser("Advantage Shopping").CloseAllTabs @@ hightlight id_;_329068_;_script infofile_;_ZIP::ssf8.xml_;_
